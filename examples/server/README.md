...
This will use the default setting for most parameters and so will only allow one simultaneous user.
To allow more simultaneous users enter -np N after -c 2048.
